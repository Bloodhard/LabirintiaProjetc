...
var _enemi_start_x = _controller_x * CELL_WIDTH + CELL_WIDTH/2;
var _enemi_start_y = _controller_y * CELL_HEIGHT + CELL_HEIGHT/2;

instance_create_layer(_player_start_x, _player_start_y, "Instances", oPlayer);
instance_create_layer(_enemi_start_x, _enemi_start_y, "Instances", oSlime);
